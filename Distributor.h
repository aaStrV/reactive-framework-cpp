...
public:
	...
	{
		DDPRINT(this);
		DDPRINT(":addIn, terminal, do nothing with ");DDPRINTLN(a);
	}

	virtual void addOut(Arrow *a)
	{
		DDPRINT(this);
		DDPRINT(":addOut, terminal, do nothing with ");DDPRINTLN(a);
	}
	...
	{
		DDPRINT(this);
		DDPRINT(":removeOut, terminal, do nothing with ");DDPRINTLN(a);
	}
};
