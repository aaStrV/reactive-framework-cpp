...
class Arrow {
 ...
 public:
  ...
  Arrow(Object *dom, Object *codom) : dom(dom), codom(codom) {
    if (codom != nullptr) {
      addIn(codom, this);
    }
    if (dom != nullptr) {
  ...
  Object *getDom(void) { return dom; }

  Object *getCodom(void) { return codom; }

  void setDom(Object *o) { dom = o; }

  void setCodom(Object *o) { codom = o; }

  virtual void apply(void *) {}

  virtual void *retrieve(void) { return nullptr; }
...
class Object {
 ...
 public:
  ...
  bool hasIn(Arrow *a) { return in_.find(a) == in_.end() ? false : true; }

  //  bool hasAnyIn(void) {
  //    return in_.size() == 0 ? false : true;
  //  }

  bool hasOut(Arrow *a) { return out_.find(a) == out_.end() ? false : true; }

  //  bool hasOut(void) {
  //    return out_.size == 0 ? false : true;
  //  }

  virtual void addIn(Arrow *a) { this->in_.insert(a); }

  virtual void addOut(Arrow *a) { this->out_.insert(a); }

  virtual void removeIn(Arrow *a) { this->in_.erase(a); }

  virtual void removeOut(Arrow *a) { this->out_.erase(a); }
...
void addIn(Object *o, Arrow *a) { o->addIn(a); }
void addOut(Object *o, Arrow *a) { o->addOut(a); }
void removeIn(Object *o, Arrow *a) { o->removeIn(a); }
void removeOut(Object *o, Arrow *a) { o->removeOut(a); }
...
class Morphism : public Arrow {
 ...
 public:
  ...
  Morphism(Object *dom, Object *codom, fun_t f) : Arrow(dom, codom), f_(f) {}
  virtual ~Morphism() {}
  ...
  virtual void *retrieve(void) { return &result_; }

  virtual void apply(void *a) { result_ = f_(*((Source *)a)); }
};
...
class Terminal : public Object {
 ...
 public:
  ...
  virtual void removeIn(Arrow *a) { delete this; }
...
class Distributor : public reacf::Object {
 public:
  ...
  Arrow *subscribe(std::function<void(T)> f) {
    ...
    Arrow *m =
        new Morphism<Terminal::terminal_t, T>(this, new_terminal, terminalF);
    return m;
  }

  void unsubscribe(Arrow *a) { delete a; }
...
class Property : Distributor<T> {
  ...
  void _subscribeSelf(void) {
    ...
    Terminal *new_terminal = new Terminal;
    Morphism<Terminal::terminal_t, T> *m =
        new Morphism<Terminal::terminal_t, T>(this, new_terminal, getF);
    self_ = m;
  }
 ...
 public:
  Property(void) { this->_subscribeSelf(); }
  virtual ~Property() {
    //        _unsubscribeSelf();
  }
  Property(T a) {
  ...
  Property(Property &p) {
    _subscribeSelf();
    Morphism<T, T> *m = new Morphism<T, T>(&p, this, [](T a) { return a; });
  }
  Property(Property &&p) {
    _unsubscribeSelf();
    p._unsubscribeSelf();
  ...
  Property &operator=(Property &&p) {
    ...
    for (auto it = this->in_.begin(), end = this->in_.end(); it != end; ++it) {
      (*it)->setCodom(this);
    }
  ...
  Property operator+(Property &arg) {
    ...
    new Morphism<T, T>(this, &p, [p_arg](T a) { return a + p_arg->value_; });

    new Morphism<T, T>(p_arg, &p, [this](T a) { return a + this->value_; });
  ...
  Property operator-(Property &arg) {
    ...
    new Morphism<T, T>(p_arg, &p, [this](T a) { return this->value_ - a; });
